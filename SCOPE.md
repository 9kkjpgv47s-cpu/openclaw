...
- For widening **automation against external incident tooling** (pages, tickets, integrations, cohorts), use the gates and kill-switch checklist in `INCIDENT_TRIAGE_CANARY.md` in addition to the rules above.
